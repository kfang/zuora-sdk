...
// @ts-ignore
import { ProxyCreateInvoiceAdjustment } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyCreateOrModifyResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyDeleteResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyGetInvoiceAdjustment } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyModifyInvoiceAdjustment } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyNoDataResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyUnauthorizedResponse } from '../../../com/zuora/models';
/**
 * InvoiceAdjustmentsApi - axios parameter creator
 * @export
 */
export const InvoiceAdjustmentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         ...
         */
        objectDELETEInvoiceAdjustment: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectDELETEInvoiceAdjustment.');
            }
            const localVarPath = `/v1/object/invoice-adjustment/{id}`
         ...
         * @throws {RequiredError}
         */
        objectGETInvoiceAdjustment: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectGETInvoiceAdjustment.');
            }
            const localVarPath = `/v1/object/invoice-adjustment/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {ProxyCreateInvoiceAdjustment} createRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPOSTInvoiceAdjustment: async (createRequest: ProxyCreateInvoiceAdjustment, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'createRequest' is not null or undefined
            if (createRequest === null || createRequest === undefined) {
                throw new RequiredError('createRequest','Required parameter createRequest was null or undefined when calling objectPOSTInvoiceAdjustment.');
            }
            const localVarPath = `/v1/object/invoice-adjustment`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @param {string} id Object id
         * @param {ProxyModifyInvoiceAdjustment} modifyRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPUTInvoiceAdjustment: async (id: string, modifyRequest: ProxyModifyInvoiceAdjustment, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectPUTInvoiceAdjustment.');
            }
            // verify required parameter 'modifyRequest' is not null or undefined
            if (modifyRequest === null || modifyRequest === undefined) {
                throw new RequiredError('modifyRequest','Required parameter modifyRequest was null or undefined when calling objectPUTInvoiceAdjustment.');
            }
            const localVarPath = `/v1/object/invoice-adjustment/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
/**
 * InvoiceAdjustmentsApi - functional programming interface
 * @export
 */
export const InvoiceAdjustmentsApiFp = function(configuration?: Configuration) {
    return {
        /**
         * 
         * @summary CRUD: Delete InvoiceAdjustment
         ...
         * @throws {RequiredError}
         */
        async objectDELETEInvoiceAdjustment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyDeleteResponse>> {
            const localVarAxiosArgs = await InvoiceAdjustmentsApiAxiosParamCreator(configuration).objectDELETEInvoiceAdjustment(id, zuoraEntityIds, zuoraTrackId, options);
         ...
         * @throws {RequiredError}
         */
        async objectGETInvoiceAdjustment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyGetInvoiceAdjustment>> {
            const localVarAxiosArgs = await InvoiceAdjustmentsApiAxiosParamCreator(configuration).objectGETInvoiceAdjustment(id, zuoraEntityIds, zuoraTrackId, fields, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPOSTInvoiceAdjustment(createRequest: ProxyCreateInvoiceAdjustment, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await InvoiceAdjustmentsApiAxiosParamCreator(configuration).objectPOSTInvoiceAdjustment(createRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPUTInvoiceAdjustment(id: string, modifyRequest: ProxyModifyInvoiceAdjustment, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await InvoiceAdjustmentsApiAxiosParamCreator(configuration).objectPUTInvoiceAdjustment(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * InvoiceAdjustmentsApi - factory interface
 * @export
 */
export const InvoiceAdjustmentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * 
         * @summary CRUD: Delete InvoiceAdjustment
         ...
         * @throws {RequiredError}
         */
        objectDELETEInvoiceAdjustment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyDeleteResponse> {
            return InvoiceAdjustmentsApiFp(configuration).objectDELETEInvoiceAdjustment(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Retrieve InvoiceAdjustment
         ...
         * @throws {RequiredError}
         */
        objectGETInvoiceAdjustment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): AxiosPromise<ProxyGetInvoiceAdjustment> {
            return InvoiceAdjustmentsApiFp(configuration).objectGETInvoiceAdjustment(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Create InvoiceAdjustment
         ...
         * @throws {RequiredError}
         */
        objectPOSTInvoiceAdjustment(createRequest: ProxyCreateInvoiceAdjustment, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return InvoiceAdjustmentsApiFp(configuration).objectPOSTInvoiceAdjustment(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Update InvoiceAdjustment
         ...
         * @throws {RequiredError}
         */
        objectPUTInvoiceAdjustment(id: string, modifyRequest: ProxyModifyInvoiceAdjustment, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return InvoiceAdjustmentsApiFp(configuration).objectPUTInvoiceAdjustment(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * InvoiceAdjustmentsApi - object-oriented interface
 * @export
 * @class InvoiceAdjustmentsApi
 * @extends {BaseAPI}
 */
export class InvoiceAdjustmentsApi extends BaseAPI {
    /**
     * 
     * @summary CRUD: Delete InvoiceAdjustment
     * @param {string} id Object id
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof InvoiceAdjustmentsApi
     */
    public objectDELETEInvoiceAdjustment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return InvoiceAdjustmentsApiFp(this.configuration).objectDELETEInvoiceAdjustment(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof InvoiceAdjustmentsApi
     */
    public objectGETInvoiceAdjustment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any) {
        return InvoiceAdjustmentsApiFp(this.configuration).objectGETInvoiceAdjustment(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof InvoiceAdjustmentsApi
     */
    public objectPOSTInvoiceAdjustment(createRequest: ProxyCreateInvoiceAdjustment, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return InvoiceAdjustmentsApiFp(this.configuration).objectPOSTInvoiceAdjustment(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof InvoiceAdjustmentsApi
     */
    public objectPUTInvoiceAdjustment(id: string, modifyRequest: ProxyModifyInvoiceAdjustment, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return InvoiceAdjustmentsApiFp(this.configuration).objectPUTInvoiceAdjustment(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
