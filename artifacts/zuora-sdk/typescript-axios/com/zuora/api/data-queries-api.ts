...
// @ts-ignore
import { DataQueryErrorResponse } from '../../../com/zuora/models';
// @ts-ignore
import { DeleteDataQueryJobResponse } from '../../../com/zuora/models';
// @ts-ignore
import { GetDataQueryJobResponse } from '../../../com/zuora/models';
// @ts-ignore
import { GetDataQueryJobsResponse } from '../../../com/zuora/models';
// @ts-ignore
import { SubmitDataQueryRequest } from '../../../com/zuora/models';
// @ts-ignore
import { SubmitDataQueryResponse } from '../../../com/zuora/models';
/**
 * DataQueriesApi - axios parameter creator
 * @export
 */
export const DataQueriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @param {string} jobId Internal identifier of the query job. 
         ...
         */
        dELETEDataQueryJob: async (authorization: string, jobId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
            if (authorization === null || authorization === undefined) {
                throw new RequiredError('authorization','Required parameter authorization was null or undefined when calling dELETEDataQueryJob.');
            }
            // verify required parameter 'jobId' is not null or undefined
            if (jobId === null || jobId === undefined) {
                throw new RequiredError('jobId','Required parameter jobId was null or undefined when calling dELETEDataQueryJob.');
            }
            const localVarPath = `/query/jobs/{job-id}`
         ...
         * @throws {RequiredError}
         */
        gETDataQueryJob: async (authorization: string, jobId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
            if (authorization === null || authorization === undefined) {
                throw new RequiredError('authorization','Required parameter authorization was null or undefined when calling gETDataQueryJob.');
            }
            // verify required parameter 'jobId' is not null or undefined
            if (jobId === null || jobId === undefined) {
                throw new RequiredError('jobId','Required parameter jobId was null or undefined when calling gETDataQueryJob.');
            }
            const localVarPath = `/query/jobs/{job-id}`
                .replace(`{${"job-id"}}`, encodeURIComponent(String(jobId)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {'accepted' | 'in_progress' | 'completed' | 'failed' | 'cancelled'} [queryStatus] Filters the list of query jobs by status. 
         * @param {number} [pageSize] Specifies the maximum number of query jobs to return. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        gETDataQueryJobs: async (authorization: string, zuoraEntityIds?: string, zuoraTrackId?: string, queryStatus?: 'accepted' | 'in_progress' | 'completed' | 'failed' | 'cancelled', pageSize?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
            if (authorization === null || authorization === undefined) {
                throw new RequiredError('authorization','Required parameter authorization was null or undefined when calling gETDataQueryJobs.');
            }
            const localVarPath = `/query/jobs`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
            ...
            if (queryStatus !== undefined) {
                localVarQueryParameter['queryStatus'] = queryStatus;
            }
         ...
         * @param {string} authorization &#x60;Bearer {token}&#x60; for a valid OAuth token. 
         * @param {SubmitDataQueryRequest} body 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        pOSTDataQueryJob: async (authorization: string, body: SubmitDataQueryRequest, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
            if (authorization === null || authorization === undefined) {
                throw new RequiredError('authorization','Required parameter authorization was null or undefined when calling pOSTDataQueryJob.');
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling pOSTDataQueryJob.');
            }
            const localVarPath = `/query/jobs`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
...
/**
 * DataQueriesApi - functional programming interface
 * @export
 */
export const DataQueriesApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Cancels a [data query](https://knowledgecenter.zuora.com/DC_Developers/BA_Data_Query) job, which prevents Zuora from performing the query. This operation is only applicable if the status of the query job is `accepted` or `in_progress`. 
         * @summary Cancel data query job
         ...
         * @throws {RequiredError}
         */
        async dELETEDataQueryJob(authorization: string, jobId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DeleteDataQueryJobResponse>> {
            const localVarAxiosArgs = await DataQueriesApiAxiosParamCreator(configuration).dELETEDataQueryJob(authorization, jobId, zuoraEntityIds, zuoraTrackId, options);
         ...
         * @throws {RequiredError}
         */
        async gETDataQueryJob(authorization: string, jobId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetDataQueryJobResponse>> {
            const localVarAxiosArgs = await DataQueriesApiAxiosParamCreator(configuration).gETDataQueryJob(authorization, jobId, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async gETDataQueryJobs(authorization: string, zuoraEntityIds?: string, zuoraTrackId?: string, queryStatus?: 'accepted' | 'in_progress' | 'completed' | 'failed' | 'cancelled', pageSize?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetDataQueryJobsResponse>> {
            const localVarAxiosArgs = await DataQueriesApiAxiosParamCreator(configuration).gETDataQueryJobs(authorization, zuoraEntityIds, zuoraTrackId, queryStatus, pageSize, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pOSTDataQueryJob(authorization: string, body: SubmitDataQueryRequest, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SubmitDataQueryResponse>> {
            const localVarAxiosArgs = await DataQueriesApiAxiosParamCreator(configuration).pOSTDataQueryJob(authorization, body, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * DataQueriesApi - factory interface
 * @export
 */
export const DataQueriesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Cancels a [data query](https://knowledgecenter.zuora.com/DC_Developers/BA_Data_Query) job, which prevents Zuora from performing the query. This operation is only applicable if the status of the query job is `accepted` or `in_progress`. 
         * @summary Cancel data query job
         ...
         * @throws {RequiredError}
         */
        dELETEDataQueryJob(authorization: string, jobId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<DeleteDataQueryJobResponse> {
            return DataQueriesApiFp(configuration).dELETEDataQueryJob(authorization, jobId, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a [data query](https://knowledgecenter.zuora.com/DC_Developers/BA_Data_Query) job. You can use this operation to track the status of the query job and obtain the URL of the query results. 
         * @summary Get data query job
         ...
         * @throws {RequiredError}
         */
        gETDataQueryJob(authorization: string, jobId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<GetDataQueryJobResponse> {
            return DataQueriesApiFp(configuration).gETDataQueryJob(authorization, jobId, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a list of [data query](https://knowledgecenter.zuora.com/DC_Developers/BA_Data_Query) jobs that have been created in your Zuora tenant. You can filter the list by status. 
         * @summary Get data query jobs
         ...
         * @throws {RequiredError}
         */
        gETDataQueryJobs(authorization: string, zuoraEntityIds?: string, zuoraTrackId?: string, queryStatus?: 'accepted' | 'in_progress' | 'completed' | 'failed' | 'cancelled', pageSize?: number, options?: any): AxiosPromise<GetDataQueryJobsResponse> {
            return DataQueriesApiFp(configuration).gETDataQueryJobs(authorization, zuoraEntityIds, zuoraTrackId, queryStatus, pageSize, options).then((request) => request(axios, basePath));
        },
        /**
         * Submits a [data query](https://knowledgecenter.zuora.com/DC_Developers/BA_Data_Query) to be performed by Zuora and creates a query job. You can use [Get data query job](#operation/GET_DataQueryJob) to track the status of the query job and obtain the URL of the query results. 
         * @summary Submit data query
         ...
         * @throws {RequiredError}
         */
        pOSTDataQueryJob(authorization: string, body: SubmitDataQueryRequest, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<SubmitDataQueryResponse> {
            return DataQueriesApiFp(configuration).pOSTDataQueryJob(authorization, body, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * DataQueriesApi - object-oriented interface
 * @export
 * @class DataQueriesApi
 * @extends {BaseAPI}
 */
export class DataQueriesApi extends BaseAPI {
    /**
     * Cancels a [data query](https://knowledgecenter.zuora.com/DC_Developers/BA_Data_Query) job, which prevents Zuora from performing the query. This operation is only applicable if the status of the query job is `accepted` or `in_progress`. 
     * @summary Cancel data query job
     * @param {string} authorization &#x60;Bearer {token}&#x60; for a valid OAuth token. 
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DataQueriesApi
     */
    public dELETEDataQueryJob(authorization: string, jobId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return DataQueriesApiFp(this.configuration).dELETEDataQueryJob(authorization, jobId, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DataQueriesApi
     */
    public gETDataQueryJob(authorization: string, jobId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return DataQueriesApiFp(this.configuration).gETDataQueryJob(authorization, jobId, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DataQueriesApi
     */
    public gETDataQueryJobs(authorization: string, zuoraEntityIds?: string, zuoraTrackId?: string, queryStatus?: 'accepted' | 'in_progress' | 'completed' | 'failed' | 'cancelled', pageSize?: number, options?: any) {
        return DataQueriesApiFp(this.configuration).gETDataQueryJobs(authorization, zuoraEntityIds, zuoraTrackId, queryStatus, pageSize, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DataQueriesApi
     */
    public pOSTDataQueryJob(authorization: string, body: SubmitDataQueryRequest, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return DataQueriesApiFp(this.configuration).pOSTDataQueryJob(authorization, body, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
