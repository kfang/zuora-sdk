...
// @ts-ignore
import { GETPaymentRunCollectionType } from '../../../com/zuora/models';
// @ts-ignore
import { GETPaymentRunSummaryResponse } from '../../../com/zuora/models';
// @ts-ignore
import { GETPaymentRunType } from '../../../com/zuora/models';
// @ts-ignore
import { POSTPaymentRunRequest } from '../../../com/zuora/models';
// @ts-ignore
import { PUTPaymentRunRequest } from '../../../com/zuora/models';
/**
 * PaymentRunsApi - axios parameter creator
 * @export
 */
export const PaymentRunsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Deletes a payment run. Only payment runs with the Canceled or Error status can be deleted. 
         * @summary Delete payment run
         * @param {string} paymentRunId The unique ID of a payment run. For example, 402890245f097f39015f0f074a2e0566. 
         ...
         */
        dELETEPaymentRun: async (paymentRunId: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'paymentRunId' is not null or undefined
            if (paymentRunId === null || paymentRunId === undefined) {
                throw new RequiredError('paymentRunId','Required parameter paymentRunId was null or undefined when calling dELETEPaymentRun.');
            }
            const localVarPath = `/v1/payment-runs/{paymentRunId}`
         ...
         * @throws {RequiredError}
         */
        gETPaymentRun: async (paymentRunId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'paymentRunId' is not null or undefined
            if (paymentRunId === null || paymentRunId === undefined) {
                throw new RequiredError('paymentRunId','Required parameter paymentRunId was null or undefined when calling gETPaymentRun.');
            }
            const localVarPath = `/v1/payment-runs/{paymentRunId}`
                .replace(`{${"paymentRunId"}}`, encodeURIComponent(String(paymentRunId)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @throws {RequiredError}
         */
        gETPaymentRunSummary: async (paymentRunId: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'paymentRunId' is not null or undefined
            if (paymentRunId === null || paymentRunId === undefined) {
                throw new RequiredError('paymentRunId','Required parameter paymentRunId was null or undefined when calling gETPaymentRunSummary.');
            }
            const localVarPath = `/v1/payment-runs/{paymentRunId}/summary`
                .replace(`{${"paymentRunId"}}`, encodeURIComponent(String(paymentRunId)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
         ...
         * @param {'Pending' | 'Processing' | 'Completed' | 'Error' | 'Canceled'} [status] This parameter filters the response based on the &#x60;status&#x60; field. 
         ...
         * @throws {RequiredError}
         */
        gETPaymentRuns: async (zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, createdById?: string, createdDate?: string, status?: 'Pending' | 'Processing' | 'Completed' | 'Error' | 'Canceled', targetDate?: string, updatedById?: string, updatedDate?: string, sort?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/payment-runs`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @param {POSTPaymentRunRequest} body 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        pOSTPaymentRun: async (body: POSTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling pOSTPaymentRun.');
            }
            const localVarPath = `/v1/payment-runs`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
         ...
         * @param {string} paymentRunId The unique ID of a payment run. For example, 402890245f097f39015f0f074a2e0566. 
         * @param {PUTPaymentRunRequest} body 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        pUTPaymentRun: async (paymentRunId: string, body: PUTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'paymentRunId' is not null or undefined
            if (paymentRunId === null || paymentRunId === undefined) {
                throw new RequiredError('paymentRunId','Required parameter paymentRunId was null or undefined when calling pUTPaymentRun.');
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling pUTPaymentRun.');
            }
            const localVarPath = `/v1/payment-runs/{paymentRunId}`
                .replace(`{${"paymentRunId"}}`, encodeURIComponent(String(paymentRunId)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
/**
 * PaymentRunsApi - functional programming interface
 * @export
 */
export const PaymentRunsApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Deletes a payment run. Only payment runs with the Canceled or Error status can be deleted. 
         * @summary Delete payment run
         ...
         * @throws {RequiredError}
         */
        async dELETEPaymentRun(paymentRunId: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResponseType>> {
            const localVarAxiosArgs = await PaymentRunsApiAxiosParamCreator(configuration).dELETEPaymentRun(paymentRunId, zuoraTrackId, options);
         ...
         * @throws {RequiredError}
         */
        async gETPaymentRun(paymentRunId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETPaymentRunType>> {
            const localVarAxiosArgs = await PaymentRunsApiAxiosParamCreator(configuration).gETPaymentRun(paymentRunId, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async gETPaymentRunSummary(paymentRunId: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETPaymentRunSummaryResponse>> {
            const localVarAxiosArgs = await PaymentRunsApiAxiosParamCreator(configuration).gETPaymentRunSummary(paymentRunId, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async gETPaymentRuns(zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, createdById?: string, createdDate?: string, status?: 'Pending' | 'Processing' | 'Completed' | 'Error' | 'Canceled', targetDate?: string, updatedById?: string, updatedDate?: string, sort?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETPaymentRunCollectionType>> {
            const localVarAxiosArgs = await PaymentRunsApiAxiosParamCreator(configuration).gETPaymentRuns(zuoraTrackId, zuoraEntityIds, pageSize, createdById, createdDate, status, targetDate, updatedById, updatedDate, sort, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pOSTPaymentRun(body: POSTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETPaymentRunType>> {
            const localVarAxiosArgs = await PaymentRunsApiAxiosParamCreator(configuration).pOSTPaymentRun(body, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pUTPaymentRun(paymentRunId: string, body: PUTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETPaymentRunType>> {
            const localVarAxiosArgs = await PaymentRunsApiAxiosParamCreator(configuration).pUTPaymentRun(paymentRunId, body, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * PaymentRunsApi - factory interface
 * @export
 */
export const PaymentRunsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Deletes a payment run. Only payment runs with the Canceled or Error status can be deleted. 
         * @summary Delete payment run
         ...
         * @throws {RequiredError}
         */
        dELETEPaymentRun(paymentRunId: string, zuoraTrackId?: string, options?: any): AxiosPromise<CommonResponseType> {
            return PaymentRunsApiFp(configuration).dELETEPaymentRun(paymentRunId, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrives the information about a specific payment run. 
         * @summary Get payment run
         ...
         * @throws {RequiredError}
         */
        gETPaymentRun(paymentRunId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<GETPaymentRunType> {
            return PaymentRunsApiFp(configuration).gETPaymentRun(paymentRunId, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrives the summary of a payment run. 
         * @summary Get payment run summary
         ...
         * @throws {RequiredError}
         */
        gETPaymentRunSummary(paymentRunId: string, zuoraTrackId?: string, options?: any): AxiosPromise<GETPaymentRunSummaryResponse> {
            return PaymentRunsApiFp(configuration).gETPaymentRunSummary(paymentRunId, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves the information about all payment runs. You can define filterable fields to restrict the data returned in the response.  ### Filtering  You can use query parameters to restrict the data returned in the response. Each query parameter corresponds to one field in the response body.  If the value of a filterable field is string, you can set the corresponding query parameter to `null` when filtering. Then, you can get the response data with this field value being `null`.   Examples:  - /v1/payment-runs?status=Processed  - /v1/payment-runs?targetDate=2017-10-10&status=Pending  - /v1/payment-runs?status=Completed&sort=+updatedDate 
         * @summary Get payment runs
         ...
         * @throws {RequiredError}
         */
        gETPaymentRuns(zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, createdById?: string, createdDate?: string, status?: 'Pending' | 'Processing' | 'Completed' | 'Error' | 'Canceled', targetDate?: string, updatedById?: string, updatedDate?: string, sort?: string, options?: any): AxiosPromise<GETPaymentRunCollectionType> {
            return PaymentRunsApiFp(configuration).gETPaymentRuns(zuoraTrackId, zuoraEntityIds, pageSize, createdById, createdDate, status, targetDate, updatedById, updatedDate, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates a payment run. You can create a payment run to be executed immediately after it is created, or a scheduced payment run to be executed in future.  The `accountId`, `batch`, `billCycleDay`, `currency`, `paymentGatewayId`, and `billingRunId` fields are used to determine which receivables to be paid in the payment run. If none of these fields is specified in the request body, the corresponding payment run collects payments for all accounts. 
         * @summary Create payment run
         ...
         * @throws {RequiredError}
         */
        pOSTPaymentRun(body: POSTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<GETPaymentRunType> {
            return PaymentRunsApiFp(configuration).pOSTPaymentRun(body, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates the information about an unexecuted payment run. Only pending payment runs can be updated.  If none of the **accountId**, **batch**, **billCycleDay**, **currency**, **paymentGatewayId**, and **billingRunId** fields is specified in the request body, the corresponding payment run collects payments for all accounts. 
         * @summary Update payment run
         ...
         * @throws {RequiredError}
         */
        pUTPaymentRun(paymentRunId: string, body: PUTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<GETPaymentRunType> {
            return PaymentRunsApiFp(configuration).pUTPaymentRun(paymentRunId, body, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * PaymentRunsApi - object-oriented interface
 * @export
 * @class PaymentRunsApi
 * @extends {BaseAPI}
 */
export class PaymentRunsApi extends BaseAPI {
    /**
     * Deletes a payment run. Only payment runs with the Canceled or Error status can be deleted. 
     * @summary Delete payment run
     * @param {string} paymentRunId The unique ID of a payment run. For example, 402890245f097f39015f0f074a2e0566. 
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof PaymentRunsApi
     */
    public dELETEPaymentRun(paymentRunId: string, zuoraTrackId?: string, options?: any) {
        return PaymentRunsApiFp(this.configuration).dELETEPaymentRun(paymentRunId, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PaymentRunsApi
     */
    public gETPaymentRun(paymentRunId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return PaymentRunsApiFp(this.configuration).gETPaymentRun(paymentRunId, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PaymentRunsApi
     */
    public gETPaymentRunSummary(paymentRunId: string, zuoraTrackId?: string, options?: any) {
        return PaymentRunsApiFp(this.configuration).gETPaymentRunSummary(paymentRunId, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PaymentRunsApi
     */
    public gETPaymentRuns(zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, createdById?: string, createdDate?: string, status?: 'Pending' | 'Processing' | 'Completed' | 'Error' | 'Canceled', targetDate?: string, updatedById?: string, updatedDate?: string, sort?: string, options?: any) {
        return PaymentRunsApiFp(this.configuration).gETPaymentRuns(zuoraTrackId, zuoraEntityIds, pageSize, createdById, createdDate, status, targetDate, updatedById, updatedDate, sort, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PaymentRunsApi
     */
    public pOSTPaymentRun(body: POSTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return PaymentRunsApiFp(this.configuration).pOSTPaymentRun(body, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PaymentRunsApi
     */
    public pUTPaymentRun(paymentRunId: string, body: PUTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return PaymentRunsApiFp(this.configuration).pUTPaymentRun(paymentRunId, body, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
