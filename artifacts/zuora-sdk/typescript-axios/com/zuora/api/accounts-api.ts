...
// @ts-ignore
import { GETAccountSummaryType } from '../../../com/zuora/models';
// @ts-ignore
import { GETAccountType } from '../../../com/zuora/models';
// @ts-ignore
import { POSTAccountResponseType } from '../../../com/zuora/models';
// @ts-ignore
import { POSTAccountType } from '../../../com/zuora/models';
// @ts-ignore
import { PUTAccountType } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyBadRequestResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyCreateAccount } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyCreateOrModifyResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyDeleteResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyGetAccount } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyModifyAccount } from '../../../com/zuora/models';
// @ts-ignore
...
export const AccountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        gETAccount: async (accountKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountKey' is not null or undefined
            if (accountKey === null || accountKey === undefined) {
                throw new RequiredError('accountKey','Required parameter accountKey was null or undefined when calling gETAccount.');
            }
            const localVarPath = `/v1/accounts/{account-key}`
         ...
         * @throws {RequiredError}
         */
        gETAccountSummary: async (accountKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountKey' is not null or undefined
            if (accountKey === null || accountKey === undefined) {
                throw new RequiredError('accountKey','Required parameter accountKey was null or undefined when calling gETAccountSummary.');
            }
            const localVarPath = `/v1/accounts/{account-key}/summary`
                .replace(`{${"account-key"}}`, encodeURIComponent(String(accountKey)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        objectDELETEAccount: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectDELETEAccount.');
            }
            const localVarPath = `/v1/object/account/{id}`
         ...
         * @throws {RequiredError}
         */
        objectGETAccount: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectGETAccount.');
            }
            const localVarPath = `/v1/object/account/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {ProxyCreateAccount} createRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPOSTAccount: async (createRequest: ProxyCreateAccount, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'createRequest' is not null or undefined
            if (createRequest === null || createRequest === undefined) {
                throw new RequiredError('createRequest','Required parameter createRequest was null or undefined when calling objectPOSTAccount.');
            }
            const localVarPath = `/v1/object/account`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @param {string} id Object id
         * @param {ProxyModifyAccount} modifyRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPUTAccount: async (id: string, modifyRequest: ProxyModifyAccount, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectPUTAccount.');
            }
            // verify required parameter 'modifyRequest' is not null or undefined
            if (modifyRequest === null || modifyRequest === undefined) {
                throw new RequiredError('modifyRequest','Required parameter modifyRequest was null or undefined when calling objectPUTAccount.');
            }
            const localVarPath = `/v1/object/account/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @throws {RequiredError}
         */
        pOSTAccount: async (request: POSTAccountType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'request' is not null or undefined
            if (request === null || request === undefined) {
                throw new RequiredError('request','Required parameter request was null or undefined when calling pOSTAccount.');
            }
         ...
         * @param {string} accountKey Account number or account ID.
         * @param {PUTAccountType} request 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        pUTAccount: async (accountKey: string, request: PUTAccountType, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountKey' is not null or undefined
            if (accountKey === null || accountKey === undefined) {
                throw new RequiredError('accountKey','Required parameter accountKey was null or undefined when calling pUTAccount.');
            }
            // verify required parameter 'request' is not null or undefined
            if (request === null || request === undefined) {
                throw new RequiredError('request','Required parameter request was null or undefined when calling pUTAccount.');
            }
            const localVarPath = `/v1/accounts/{account-key}`
                .replace(`{${"account-key"}}`, encodeURIComponent(String(accountKey)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const AccountsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async gETAccount(accountKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETAccountType>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).gETAccount(accountKey, zuoraTrackId, zuoraEntityIds, options);
         ...
         * @throws {RequiredError}
         */
        async gETAccountSummary(accountKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETAccountSummaryType>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).gETAccountSummary(accountKey, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectDELETEAccount(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyDeleteResponse>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).objectDELETEAccount(id, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectGETAccount(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyGetAccount>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).objectGETAccount(id, zuoraEntityIds, zuoraTrackId, fields, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPOSTAccount(createRequest: ProxyCreateAccount, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).objectPOSTAccount(createRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPUTAccount(id: string, modifyRequest: ProxyModifyAccount, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).objectPUTAccount(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pOSTAccount(request: POSTAccountType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<POSTAccountResponseType>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).pOSTAccount(request, zuoraTrackId, zuoraEntityIds, zuoraVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pUTAccount(accountKey: string, request: PUTAccountType, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResponseType>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).pUTAccount(accountKey, request, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const AccountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        gETAccount(accountKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<GETAccountType> {
            return AccountsApiFp(configuration).gETAccount(accountKey, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves detailed information about the specified customer account.  The response includes the account information and a summary of the account’s subscriptions, invoices, payments, and usages for the last six recently updated subscriptions.  ## Notes  Returns only the six most recent subscriptions based on the subscription updatedDate. Within those subscriptions, there may be many rate plans and many rate plan charges. These items are subject to the maximum limit on the array size.  
         * @summary Get account summary
         ...
         * @throws {RequiredError}
         */
        gETAccountSummary(accountKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<GETAccountSummaryType> {
            return AccountsApiFp(configuration).gETAccountSummary(accountKey, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes a specific account asynchronously.   **Note:** When [Orders](https://knowledgecenter.zuora.com/BC_Subscription_Management/Orders/AA_Overview_of_Orders#Orders) is enabled, before deleting a customer account, you must delete all related orders and subscriptions where this account has been referenced as a subscription owner or invoice owner. 
         * @summary CRUD: Delete account
         ...
         * @throws {RequiredError}
         */
        objectDELETEAccount(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyDeleteResponse> {
            return AccountsApiFp(configuration).objectDELETEAccount(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves the information about one specific account. 
         * @summary CRUD: Get account
         ...
         * @throws {RequiredError}
         */
        objectGETAccount(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): AxiosPromise<ProxyGetAccount> {
            return AccountsApiFp(configuration).objectGETAccount(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates an account without creating any associated objects such as subscriptions. 
         * @summary CRUD: Create account
         ...
         * @throws {RequiredError}
         */
        objectPOSTAccount(createRequest: ProxyCreateAccount, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return AccountsApiFp(configuration).objectPOSTAccount(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates an account. 
         * @summary CRUD: Update account
         ...
         * @throws {RequiredError}
         */
        objectPUTAccount(id: string, modifyRequest: ProxyModifyAccount, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return AccountsApiFp(configuration).objectPUTAccount(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates a customer account with a payment method, a bill-to contact, and an optional sold-to contact. Request and response field descriptions and sample code are provided. Use this operation to optionally create a subscription, invoice for that subscription, and collect payment through the default payment method. The transaction is atomic; if any part fails for any reason, the entire transaction is rolled back.  This operation is CORS Enabled, so you can use client-side Javascript to invoke the call.   ## Notes 1. The account is created in active status.   2. If the `autoPay` field is set to `true` in the request, you must provide one of the `paymentMethod`, `creditCard`, or `hpmCreditCardPaymentMethodId` field, but not multiple. The one provided becomes the default payment method for this account. If the credit card information is declined or cannot be verified, no account is created. 3. Customer accounts created with this call are automatically be set to Auto Pay. 4. If either the `workEmail` or `personalEmail` field is specified, then the account\'s email delivery preference is automatically set to `true`. (In that case, emails go to the `workEmail` address, if it exists, or else the `personalEmail`.) If neither field is specified, the email delivery preference is automatically set to `false`.  ## Defaults for customerAcceptanceDate and serviceActivationDate Default values for **customerAcceptanceDate** and **serviceActivationDate** are set as follows.  |        | serviceActivationDate(SA) specified          | serviceActivationDate (SA) NOT specified  | | ------------- |:-------------:| -----:| | customerAcceptanceDate (CA) specified      | SA uses value in the request call; CA uses value in the request call| CA uses value in the request call;SA uses CE as default | | customerAcceptanceDate (CA) NOT specified      | SA uses value in the request call; CA uses SA as default |   SA and CA use CE as default | 
         * @summary Create account
         ...
         * @throws {RequiredError}
         */
        pOSTAccount(request: POSTAccountType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options?: any): AxiosPromise<POSTAccountResponseType> {
            return AccountsApiFp(configuration).pOSTAccount(request, zuoraTrackId, zuoraEntityIds, zuoraVersion, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates a customer account by specifying the account-key.  ## Notes 1. Only the fields to be changed should be specified.  Any field that is not included in the request body will not be changed. 2. If an empty field is submitted with this operation, the corresponding field in the account is emptied. 3. Email addresses: If no email addresses are specified, no change is made to the email addresses on file or to the email delivery preference. If either the **personalEmail** or **workEmail** is specified (or both), the system updates the corresponding email address(es) on file and the email delivery preference is set to `true`. (In that case, emails go to the **workEmail** address, if it exists, or else the **personalEmail**.) On the other hand, if as a result of this call both of the email addresses for the account are empty, the email delivery preference is set to `false`. 4. The bill-to and sold-to contacts are separate data entities; updating either one does not update the other. 
         * @summary Update account
         ...
         * @throws {RequiredError}
         */
        pUTAccount(accountKey: string, request: PUTAccountType, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<CommonResponseType> {
            return AccountsApiFp(configuration).pUTAccount(accountKey, request, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AccountsApi extends BaseAPI {
     ...
     */
    public gETAccount(accountKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return AccountsApiFp(this.configuration).gETAccount(accountKey, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountsApi
     */
    public gETAccountSummary(accountKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return AccountsApiFp(this.configuration).gETAccountSummary(accountKey, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountsApi
     */
    public objectDELETEAccount(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return AccountsApiFp(this.configuration).objectDELETEAccount(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountsApi
     */
    public objectGETAccount(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any) {
        return AccountsApiFp(this.configuration).objectGETAccount(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountsApi
     */
    public objectPOSTAccount(createRequest: ProxyCreateAccount, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return AccountsApiFp(this.configuration).objectPOSTAccount(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountsApi
     */
    public objectPUTAccount(id: string, modifyRequest: ProxyModifyAccount, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return AccountsApiFp(this.configuration).objectPUTAccount(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountsApi
     */
    public pOSTAccount(request: POSTAccountType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options?: any) {
        return AccountsApiFp(this.configuration).pOSTAccount(request, zuoraTrackId, zuoraEntityIds, zuoraVersion, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountsApi
     */
    public pUTAccount(accountKey: string, request: PUTAccountType, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return AccountsApiFp(this.configuration).pUTAccount(accountKey, request, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
