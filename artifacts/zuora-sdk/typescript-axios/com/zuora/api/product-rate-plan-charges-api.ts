...
// @ts-ignore
import { ProxyCreateProductRatePlanCharge } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyDeleteResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyGetProductRatePlanCharge } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyModifyProductRatePlanCharge } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyNoDataResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyUnauthorizedResponse } from '../../../com/zuora/models';
/**
 * ProductRatePlanChargesApi - axios parameter creator
 * @export
 */
export const ProductRatePlanChargesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Deletes a product rate plan charge. 
         * @summary CRUD: Delete product rate plan charge
         * @param {string} id The unique ID of the product rate plan charge to be deleted. For example, 2c93808457d787030157e031fcd34e19. 
         ...
         */
        objectDELETEProductRatePlanCharge: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectDELETEProductRatePlanCharge.');
            }
            const localVarPath = `/v1/object/product-rate-plan-charge/{id}`
         ...
         * @param {string} id The unique ID of a product rate plan charge to be retrieved. For example, 2c93808457d787030157e031fcd34e19. 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         ...
         * @throws {RequiredError}
         */
        objectGETProductRatePlanCharge: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectGETProductRatePlanCharge.');
            }
            const localVarPath = `/v1/object/product-rate-plan-charge/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {ProxyCreateProductRatePlanCharge} createRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPOSTProductRatePlanCharge: async (createRequest: ProxyCreateProductRatePlanCharge, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'createRequest' is not null or undefined
            if (createRequest === null || createRequest === undefined) {
                throw new RequiredError('createRequest','Required parameter createRequest was null or undefined when calling objectPOSTProductRatePlanCharge.');
            }
            const localVarPath = `/v1/object/product-rate-plan-charge`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @param {string} id The unique ID of the product rate plan charge to be updated. For example, 2c93808457d787030157e031fcd34e19. 
         * @param {ProxyModifyProductRatePlanCharge} modifyRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPUTProductRatePlanCharge: async (id: string, modifyRequest: ProxyModifyProductRatePlanCharge, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectPUTProductRatePlanCharge.');
            }
            // verify required parameter 'modifyRequest' is not null or undefined
            if (modifyRequest === null || modifyRequest === undefined) {
                throw new RequiredError('modifyRequest','Required parameter modifyRequest was null or undefined when calling objectPUTProductRatePlanCharge.');
            }
            const localVarPath = `/v1/object/product-rate-plan-charge/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
/**
 * ProductRatePlanChargesApi - functional programming interface
 * @export
 */
export const ProductRatePlanChargesApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Deletes a product rate plan charge. 
         * @summary CRUD: Delete product rate plan charge
         ...
         * @throws {RequiredError}
         */
        async objectDELETEProductRatePlanCharge(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyDeleteResponse>> {
            const localVarAxiosArgs = await ProductRatePlanChargesApiAxiosParamCreator(configuration).objectDELETEProductRatePlanCharge(id, zuoraEntityIds, zuoraTrackId, options);
         ...
         * @throws {RequiredError}
         */
        async objectGETProductRatePlanCharge(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyGetProductRatePlanCharge>> {
            const localVarAxiosArgs = await ProductRatePlanChargesApiAxiosParamCreator(configuration).objectGETProductRatePlanCharge(id, zuoraEntityIds, zuoraTrackId, fields, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPOSTProductRatePlanCharge(createRequest: ProxyCreateProductRatePlanCharge, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await ProductRatePlanChargesApiAxiosParamCreator(configuration).objectPOSTProductRatePlanCharge(createRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPUTProductRatePlanCharge(id: string, modifyRequest: ProxyModifyProductRatePlanCharge, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await ProductRatePlanChargesApiAxiosParamCreator(configuration).objectPUTProductRatePlanCharge(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * ProductRatePlanChargesApi - factory interface
 * @export
 */
export const ProductRatePlanChargesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Deletes a product rate plan charge. 
         * @summary CRUD: Delete product rate plan charge
         ...
         * @throws {RequiredError}
         */
        objectDELETEProductRatePlanCharge(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyDeleteResponse> {
            return ProductRatePlanChargesApiFp(configuration).objectDELETEProductRatePlanCharge(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Get product rate plan charge
         ...
         * @throws {RequiredError}
         */
        objectGETProductRatePlanCharge(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): AxiosPromise<ProxyGetProductRatePlanCharge> {
            return ProductRatePlanChargesApiFp(configuration).objectGETProductRatePlanCharge(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates a product rate plan charge for a specified rate plan charge.   Product rate plan charges can be of three types, one-time fees, recurring fees, and usage fees.  
         * @summary CRUD: Create product rate plan charge
         ...
         * @throws {RequiredError}
         */
        objectPOSTProductRatePlanCharge(createRequest: ProxyCreateProductRatePlanCharge, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return ProductRatePlanChargesApiFp(configuration).objectPOSTProductRatePlanCharge(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates the information about a product rate plan charge. 
         * @summary CRUD: Update product rate plan charge
         ...
         * @throws {RequiredError}
         */
        objectPUTProductRatePlanCharge(id: string, modifyRequest: ProxyModifyProductRatePlanCharge, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return ProductRatePlanChargesApiFp(configuration).objectPUTProductRatePlanCharge(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * ProductRatePlanChargesApi - object-oriented interface
 * @export
 * @class ProductRatePlanChargesApi
 * @extends {BaseAPI}
 */
export class ProductRatePlanChargesApi extends BaseAPI {
    /**
     * Deletes a product rate plan charge. 
     * @summary CRUD: Delete product rate plan charge
     * @param {string} id The unique ID of the product rate plan charge to be deleted. For example, 2c93808457d787030157e031fcd34e19. 
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ProductRatePlanChargesApi
     */
    public objectDELETEProductRatePlanCharge(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return ProductRatePlanChargesApiFp(this.configuration).objectDELETEProductRatePlanCharge(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductRatePlanChargesApi
     */
    public objectGETProductRatePlanCharge(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any) {
        return ProductRatePlanChargesApiFp(this.configuration).objectGETProductRatePlanCharge(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductRatePlanChargesApi
     */
    public objectPOSTProductRatePlanCharge(createRequest: ProxyCreateProductRatePlanCharge, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return ProductRatePlanChargesApiFp(this.configuration).objectPOSTProductRatePlanCharge(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductRatePlanChargesApi
     */
    public objectPUTProductRatePlanCharge(id: string, modifyRequest: ProxyModifyProductRatePlanCharge, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return ProductRatePlanChargesApiFp(this.configuration).objectPUTProductRatePlanCharge(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
