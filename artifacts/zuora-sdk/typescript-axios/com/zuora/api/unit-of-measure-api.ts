...
// @ts-ignore
import { ProxyCreateUnitOfMeasure } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyDeleteResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyGetUnitOfMeasure } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyModifyUnitOfMeasure } from '../../../com/zuora/models';
// @ts-ignore
...
export const UnitOfMeasureApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        objectDELETEUnitOfMeasure: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectDELETEUnitOfMeasure.');
            }
            const localVarPath = `/v1/object/unit-of-measure/{id}`
         ...
         * @throws {RequiredError}
         */
        objectGETUnitOfMeasure: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectGETUnitOfMeasure.');
            }
            const localVarPath = `/v1/object/unit-of-measure/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {ProxyCreateUnitOfMeasure} createRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPOSTUnitOfMeasure: async (createRequest: ProxyCreateUnitOfMeasure, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'createRequest' is not null or undefined
            if (createRequest === null || createRequest === undefined) {
                throw new RequiredError('createRequest','Required parameter createRequest was null or undefined when calling objectPOSTUnitOfMeasure.');
            }
            const localVarPath = `/v1/object/unit-of-measure`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @param {string} id Object id
         * @param {ProxyModifyUnitOfMeasure} modifyRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPUTUnitOfMeasure: async (id: string, modifyRequest: ProxyModifyUnitOfMeasure, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectPUTUnitOfMeasure.');
            }
            // verify required parameter 'modifyRequest' is not null or undefined
            if (modifyRequest === null || modifyRequest === undefined) {
                throw new RequiredError('modifyRequest','Required parameter modifyRequest was null or undefined when calling objectPUTUnitOfMeasure.');
            }
            const localVarPath = `/v1/object/unit-of-measure/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const UnitOfMeasureApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async objectDELETEUnitOfMeasure(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyDeleteResponse>> {
            const localVarAxiosArgs = await UnitOfMeasureApiAxiosParamCreator(configuration).objectDELETEUnitOfMeasure(id, zuoraEntityIds, zuoraTrackId, options);
         ...
         * @throws {RequiredError}
         */
        async objectGETUnitOfMeasure(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyGetUnitOfMeasure>> {
            const localVarAxiosArgs = await UnitOfMeasureApiAxiosParamCreator(configuration).objectGETUnitOfMeasure(id, zuoraEntityIds, zuoraTrackId, fields, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPOSTUnitOfMeasure(createRequest: ProxyCreateUnitOfMeasure, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await UnitOfMeasureApiAxiosParamCreator(configuration).objectPOSTUnitOfMeasure(createRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPUTUnitOfMeasure(id: string, modifyRequest: ProxyModifyUnitOfMeasure, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await UnitOfMeasureApiAxiosParamCreator(configuration).objectPUTUnitOfMeasure(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const UnitOfMeasureApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        objectDELETEUnitOfMeasure(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyDeleteResponse> {
            return UnitOfMeasureApiFp(configuration).objectDELETEUnitOfMeasure(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Retrieve UnitOfMeasure
         ...
         * @throws {RequiredError}
         */
        objectGETUnitOfMeasure(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): AxiosPromise<ProxyGetUnitOfMeasure> {
            return UnitOfMeasureApiFp(configuration).objectGETUnitOfMeasure(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Create UnitOfMeasure
         ...
         * @throws {RequiredError}
         */
        objectPOSTUnitOfMeasure(createRequest: ProxyCreateUnitOfMeasure, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return UnitOfMeasureApiFp(configuration).objectPOSTUnitOfMeasure(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Update UnitOfMeasure
         ...
         * @throws {RequiredError}
         */
        objectPUTUnitOfMeasure(id: string, modifyRequest: ProxyModifyUnitOfMeasure, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return UnitOfMeasureApiFp(configuration).objectPUTUnitOfMeasure(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UnitOfMeasureApi extends BaseAPI {
     ...
     */
    public objectDELETEUnitOfMeasure(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return UnitOfMeasureApiFp(this.configuration).objectDELETEUnitOfMeasure(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UnitOfMeasureApi
     */
    public objectGETUnitOfMeasure(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any) {
        return UnitOfMeasureApiFp(this.configuration).objectGETUnitOfMeasure(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UnitOfMeasureApi
     */
    public objectPOSTUnitOfMeasure(createRequest: ProxyCreateUnitOfMeasure, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return UnitOfMeasureApiFp(this.configuration).objectPOSTUnitOfMeasure(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UnitOfMeasureApi
     */
    public objectPUTUnitOfMeasure(id: string, modifyRequest: ProxyModifyUnitOfMeasure, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return UnitOfMeasureApiFp(this.configuration).objectPUTUnitOfMeasure(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
