...
// @ts-ignore
import { GETAttachmentResponseType } from '../../../com/zuora/models';
// @ts-ignore
import { GETAttachmentsResponseType } from '../../../com/zuora/models';
// @ts-ignore
import { POSTAttachmentResponseType } from '../../../com/zuora/models';
// @ts-ignore
import { PUTAttachmentType } from '../../../com/zuora/models';
/**
...
export const AttachmentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        dELETEAttachments: async (attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'attachmentId' is not null or undefined
            if (attachmentId === null || attachmentId === undefined) {
                throw new RequiredError('attachmentId','Required parameter attachmentId was null or undefined when calling dELETEAttachments.');
            }
            const localVarPath = `/v1/attachments/{attachment-id}`
         ...
         * @param {string} attachmentId Id of the attachment you want to view.
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        gETAttachments: async (attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'attachmentId' is not null or undefined
            if (attachmentId === null || attachmentId === undefined) {
                throw new RequiredError('attachmentId','Required parameter attachmentId was null or undefined when calling gETAttachments.');
            }
            const localVarPath = `/v1/attachments/{attachment-id}`
                .replace(`{${"attachment-id"}}`, encodeURIComponent(String(attachmentId)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {'account' | 'invoice' | 'subscription'} objectType The type of object to list attachements for. 
         * @param {string} objectKey ID of the object to list attachements for.  - If &#x60;object-type&#x60; is &#x60;account&#x60;, specify an account ID.  - If &#x60;object-type&#x60; is &#x60;invoice&#x60;, specify an invoice ID.  - If &#x60;object-type&#x60; is &#x60;subscription&#x60;, specify a subscription number. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         ...
         * @throws {RequiredError}
         */
        gETAttachmentsList: async (objectType: 'account' | 'invoice' | 'subscription', objectKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'objectType' is not null or undefined
            if (objectType === null || objectType === undefined) {
                throw new RequiredError('objectType','Required parameter objectType was null or undefined when calling gETAttachmentsList.');
            }
            // verify required parameter 'objectKey' is not null or undefined
            if (objectKey === null || objectKey === undefined) {
                throw new RequiredError('objectKey','Required parameter objectKey was null or undefined when calling gETAttachmentsList.');
            }
            const localVarPath = `/v1/attachments/{object-type}/{object-key}`
         ...
         * @param {string} associatedObjectType Specify one of the following values: Account, Subscription, or Invoice. 
         * @param {string} associatedObjectKey For the Subscription type, specify the Subscription Number. An attachment is tied to the Subscription Number and thus viewable with every subscription version.  For Account and Invoice, specify the id. 
         * @param {any} file The file to be attached. Files with the following extensions are supported: .pdf, .csv, .png, .xlsx, .xls, .doc, .docx, .msg, .jpg, .txt, .htm, .html, .eml, .pptx, .gif, .rtf, .xml, .jpeg, .log, .cls  The maximum file size is 4 MB. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [description] Description of the attachment document. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        pOSTAttachments: async (associatedObjectType: string, associatedObjectKey: string, file: any, zuoraTrackId?: string, zuoraEntityIds?: string, description?: string, options: any = {}): Promise<RequestArgs> => {
            ...
            if (associatedObjectType === null || associatedObjectType === undefined) {
                throw new RequiredError('associatedObjectType','Required parameter associatedObjectType was null or undefined when calling pOSTAttachments.');
            }
            ...
            if (associatedObjectKey === null || associatedObjectKey === undefined) {
                throw new RequiredError('associatedObjectKey','Required parameter associatedObjectKey was null or undefined when calling pOSTAttachments.');
            }
            // verify required parameter 'file' is not null or undefined
            if (file === null || file === undefined) {
                throw new RequiredError('file','Required parameter file was null or undefined when calling pOSTAttachments.');
            }
            ...
            if (associatedObjectType !== undefined) {
                localVarQueryParameter['associatedObjectType'] = associatedObjectType;
            }

            if (associatedObjectKey !== undefined) {
                localVarQueryParameter['associatedObjectKey'] = associatedObjectKey;
            }
         ...
         * @throws {RequiredError}
         */
        pUTAttachments: async (attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, request?: PUTAttachmentType, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'attachmentId' is not null or undefined
            if (attachmentId === null || attachmentId === undefined) {
                throw new RequiredError('attachmentId','Required parameter attachmentId was null or undefined when calling pUTAttachments.');
            }
            const localVarPath = `/v1/attachments/{attachment-id}`
                .replace(`{${"attachment-id"}}`, encodeURIComponent(String(attachmentId)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const AttachmentsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async dELETEAttachments(attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResponseType>> {
            const localVarAxiosArgs = await AttachmentsApiAxiosParamCreator(configuration).dELETEAttachments(attachmentId, zuoraTrackId, zuoraEntityIds, options);
         ...
         * @throws {RequiredError}
         */
        async gETAttachments(attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETAttachmentResponseType>> {
            const localVarAxiosArgs = await AttachmentsApiAxiosParamCreator(configuration).gETAttachments(attachmentId, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async gETAttachmentsList(objectType: 'account' | 'invoice' | 'subscription', objectKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETAttachmentsResponseType>> {
            const localVarAxiosArgs = await AttachmentsApiAxiosParamCreator(configuration).gETAttachmentsList(objectType, objectKey, zuoraTrackId, zuoraEntityIds, pageSize, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pOSTAttachments(associatedObjectType: string, associatedObjectKey: string, file: any, zuoraTrackId?: string, zuoraEntityIds?: string, description?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<POSTAttachmentResponseType>> {
            const localVarAxiosArgs = await AttachmentsApiAxiosParamCreator(configuration).pOSTAttachments(associatedObjectType, associatedObjectKey, file, zuoraTrackId, zuoraEntityIds, description, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pUTAttachments(attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, request?: PUTAttachmentType, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResponseType>> {
            const localVarAxiosArgs = await AttachmentsApiAxiosParamCreator(configuration).pUTAttachments(attachmentId, zuoraTrackId, zuoraEntityIds, request, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const AttachmentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        dELETEAttachments(attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<CommonResponseType> {
            return AttachmentsApiFp(configuration).dELETEAttachments(attachmentId, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * Use the View Attachment REST request to retrieve information about an attachment document.
         * @summary View attachments
         ...
         * @throws {RequiredError}
         */
        gETAttachments(attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<GETAttachmentResponseType> {
            return AttachmentsApiFp(configuration).gETAttachments(attachmentId, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * Use the View Attachment REST request to get a list of attachments on an account, an invoice, or a subscription.
         * @summary View attachments list
         ...
         * @throws {RequiredError}
         */
        gETAttachmentsList(objectType: 'account' | 'invoice' | 'subscription', objectKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options?: any): AxiosPromise<GETAttachmentsResponseType> {
            return AttachmentsApiFp(configuration).gETAttachmentsList(objectType, objectKey, zuoraTrackId, zuoraEntityIds, pageSize, options).then((request) => request(axios, basePath));
        },
        /**
         * Use the Add Attachment REST request with a multipart/form-data to attach a document file to an Account, a Subscription, or an Invoice.
         * @summary Add attachments
         ...
         * @throws {RequiredError}
         */
        pOSTAttachments(associatedObjectType: string, associatedObjectKey: string, file: any, zuoraTrackId?: string, zuoraEntityIds?: string, description?: string, options?: any): AxiosPromise<POSTAttachmentResponseType> {
            return AttachmentsApiFp(configuration).pOSTAttachments(associatedObjectType, associatedObjectKey, file, zuoraTrackId, zuoraEntityIds, description, options).then((request) => request(axios, basePath));
        },
        /**
         * Use the Edit Attachment REST request to make changes to the descriptive fields of an attachment, such as the description and the file name. You cannot change the actual content of the attached file in Zuora. If you need to change the actual content, you need to delete the attachment and add the updated file as a new attachment.
         * @summary Edit attachments
         ...
         * @throws {RequiredError}
         */
        pUTAttachments(attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, request?: PUTAttachmentType, options?: any): AxiosPromise<CommonResponseType> {
            return AttachmentsApiFp(configuration).pUTAttachments(attachmentId, zuoraTrackId, zuoraEntityIds, request, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AttachmentsApi extends BaseAPI {
     ...
     */
    public dELETEAttachments(attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return AttachmentsApiFp(this.configuration).dELETEAttachments(attachmentId, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachmentsApi
     */
    public gETAttachments(attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return AttachmentsApiFp(this.configuration).gETAttachments(attachmentId, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachmentsApi
     */
    public gETAttachmentsList(objectType: 'account' | 'invoice' | 'subscription', objectKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options?: any) {
        return AttachmentsApiFp(this.configuration).gETAttachmentsList(objectType, objectKey, zuoraTrackId, zuoraEntityIds, pageSize, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachmentsApi
     */
    public pOSTAttachments(associatedObjectType: string, associatedObjectKey: string, file: any, zuoraTrackId?: string, zuoraEntityIds?: string, description?: string, options?: any) {
        return AttachmentsApiFp(this.configuration).pOSTAttachments(associatedObjectType, associatedObjectKey, file, zuoraTrackId, zuoraEntityIds, description, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachmentsApi
     */
    public pUTAttachments(attachmentId: string, zuoraTrackId?: string, zuoraEntityIds?: string, request?: PUTAttachmentType, options?: any) {
        return AttachmentsApiFp(this.configuration).pUTAttachments(attachmentId, zuoraTrackId, zuoraEntityIds, request, options).then((request) => request(this.axios, this.basePath));
    }
