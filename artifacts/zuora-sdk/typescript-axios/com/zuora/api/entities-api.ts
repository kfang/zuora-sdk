...
// @ts-ignore
import { CreateEntityResponseType } from '../../../com/zuora/models';
// @ts-ignore
import { CreateEntityType } from '../../../com/zuora/models';
// @ts-ignore
import { DELETEntityResponseType } from '../../../com/zuora/models';
// @ts-ignore
import { GETEntitiesResponseType } from '../../../com/zuora/models';
// @ts-ignore
import { GETEntitiesResponseTypeWithId } from '../../../com/zuora/models';
// @ts-ignore
import { ProvisionEntityResponseType } from '../../../com/zuora/models';
// @ts-ignore
import { UpdateEntityResponseType } from '../../../com/zuora/models';
// @ts-ignore
import { UpdateEntityType } from '../../../com/zuora/models';
/**
...
export const EntitiesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} id Specify the Id of the entity that you want to delete. You can get the entity Id from the GET Entities call.
         ...
         */
        dELETEEntities: async (id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling dELETEEntities.');
            }
            const localVarPath = `/v1/entities/{id}`
         ...
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [provisioned] Specify whether to retrieve provisioned or unprovisioned entities:  - &#x60;true&#x60;: Provisioned entities  - &#x60;false&#x60;: Unprovisioned entities   If you do not specify this field in the request, both the provisioned and unprovisioned entities are returned. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        gETEntities: async (zuoraTrackId?: string, zuoraEntityIds?: string, provisioned?: string, options: any = {}): Promise<RequestArgs> => {
         ...
         * @param {string} id Specify the Id of the entity that you want to retrieve. You can get the entity Id from the GET Entities call.
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        gETEntityById: async (id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling gETEntityById.');
            }
            const localVarPath = `/v1/entities/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {CreateEntityType} request 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        pOSTEntities: async (request: CreateEntityType, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'request' is not null or undefined
            if (request === null || request === undefined) {
                throw new RequiredError('request','Required parameter request was null or undefined when calling pOSTEntities.');
            }
            const localVarPath = `/v1/entities`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
         ...
         * @param {string} id The Id of the entity that you want to edit. You can get the entity Id from the GET Entities call.
         * @param {UpdateEntityType} request 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        pUTEntities: async (id: string, request: UpdateEntityType, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling pUTEntities.');
            }
            // verify required parameter 'request' is not null or undefined
            if (request === null || request === undefined) {
                throw new RequiredError('request','Required parameter request was null or undefined when calling pUTEntities.');
            }
            const localVarPath = `/v1/entities/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {string} id Specify the Id of the entity that you want to provision.  You can get the entity Id from the GET Entities call.
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        pUTProvisionEntity: async (id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling pUTProvisionEntity.');
            }
            const localVarPath = `/v1/entities/{id}/provision`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
...
export const EntitiesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async dELETEEntities(id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DELETEntityResponseType>> {
            const localVarAxiosArgs = await EntitiesApiAxiosParamCreator(configuration).dELETEEntities(id, zuoraTrackId, zuoraEntityIds, options);
         ...
         * @throws {RequiredError}
         */
        async gETEntities(zuoraTrackId?: string, zuoraEntityIds?: string, provisioned?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETEntitiesResponseType>> {
            const localVarAxiosArgs = await EntitiesApiAxiosParamCreator(configuration).gETEntities(zuoraTrackId, zuoraEntityIds, provisioned, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async gETEntityById(id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETEntitiesResponseTypeWithId>> {
            const localVarAxiosArgs = await EntitiesApiAxiosParamCreator(configuration).gETEntityById(id, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pOSTEntities(request: CreateEntityType, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateEntityResponseType>> {
            const localVarAxiosArgs = await EntitiesApiAxiosParamCreator(configuration).pOSTEntities(request, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pUTEntities(id: string, request: UpdateEntityType, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateEntityResponseType>> {
            const localVarAxiosArgs = await EntitiesApiAxiosParamCreator(configuration).pUTEntities(id, request, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pUTProvisionEntity(id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProvisionEntityResponseType>> {
            const localVarAxiosArgs = await EntitiesApiAxiosParamCreator(configuration).pUTProvisionEntity(id, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const EntitiesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        dELETEEntities(id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<DELETEntityResponseType> {
            return EntitiesApiFp(configuration).dELETEEntities(id, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * **Note:** The Multi-entity feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).    Retrieves detailed information of certain entities in a multi-entity hierarchy.   You can retrieve:   - Provisioned entities     - Unprovisioned entities     - Both provisioned and unprovisioned entities  ## User Access Permission  You can make the call as any entity user. 
         * @summary Multi-entity: Get entities
         ...
         * @throws {RequiredError}
         */
        gETEntities(zuoraTrackId?: string, zuoraEntityIds?: string, provisioned?: string, options?: any): AxiosPromise<GETEntitiesResponseType> {
            return EntitiesApiFp(configuration).gETEntities(zuoraTrackId, zuoraEntityIds, provisioned, options).then((request) => request(axios, basePath));
        },
        /**
         * **Note:** The Multi-entity feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieves detailed information about a specified entity.  ## User Access Permission You can make the call as any entity user.      
         * @summary Multi-entity: Get entity by Id
         ...
         * @throws {RequiredError}
         */
        gETEntityById(id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<GETEntitiesResponseTypeWithId> {
            return EntitiesApiFp(configuration).gETEntityById(id, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * **Note:** The Multi-entity feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Creates an entity in a multi-entity hierarchy.  ## User Access Permission You must make the call as a global entity administrator.  ## Notes * We recommend that you assign only one administrator to manage the entity hierarchy, because an administrator of the global entity by default can only access to the entities that are created by themselves. 
         * @summary Multi-entity: Create entity
         ...
         * @throws {RequiredError}
         */
        pOSTEntities(request: CreateEntityType, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<CreateEntityResponseType> {
            return EntitiesApiFp(configuration).pOSTEntities(request, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * **Note:** The Multi-entity feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Edits the following information about an unprovisioned entity:   - Name    - Display name    - Locale    - Timezone  ## User Access Permission You must make the call as a global entity administrator.  ## Notes * You are not allowed to edit the locale and time zone of the provisioned entities through the REST API. * You are not allowed to edit the display name of the global entity. 
         * @summary Multi-entity: Update entity
         ...
         * @throws {RequiredError}
         */
        pUTEntities(id: string, request: UpdateEntityType, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<UpdateEntityResponseType> {
            return EntitiesApiFp(configuration).pUTEntities(id, request, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * **Note:** The Multi-entity feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Provisions an entity. You can only provision an entity if its parent entity is provisioned.  ## User Access Permission You must make the call as a global entity administrator.   ## Notes * Zuora does not allow you to remove a provisioned entity from the multi-entity hierarchy. So before you provision an entity, make sure that you put the entity in the correct place in the multi-entity hierarchy.  
         * @summary Multi-entity: Provision entity
         ...
         * @throws {RequiredError}
         */
        pUTProvisionEntity(id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<ProvisionEntityResponseType> {
            return EntitiesApiFp(configuration).pUTProvisionEntity(id, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class EntitiesApi extends BaseAPI {
     ...
     */
    public dELETEEntities(id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return EntitiesApiFp(this.configuration).dELETEEntities(id, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EntitiesApi
     */
    public gETEntities(zuoraTrackId?: string, zuoraEntityIds?: string, provisioned?: string, options?: any) {
        return EntitiesApiFp(this.configuration).gETEntities(zuoraTrackId, zuoraEntityIds, provisioned, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EntitiesApi
     */
    public gETEntityById(id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return EntitiesApiFp(this.configuration).gETEntityById(id, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EntitiesApi
     */
    public pOSTEntities(request: CreateEntityType, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return EntitiesApiFp(this.configuration).pOSTEntities(request, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EntitiesApi
     */
    public pUTEntities(id: string, request: UpdateEntityType, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return EntitiesApiFp(this.configuration).pUTEntities(id, request, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EntitiesApi
     */
    public pUTProvisionEntity(id: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return EntitiesApiFp(this.configuration).pUTProvisionEntity(id, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
