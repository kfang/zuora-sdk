...
// @ts-ignore
import { GETAmendmentType } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyCreateOrModifyResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyDeleteResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyGetAmendment } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyModifyAmendment } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyNoDataResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyUnauthorizedResponse } from '../../../com/zuora/models';
/**
 * AmendmentsApi - axios parameter creator
 * @export
 */
export const AmendmentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Retrieves detailed information about the specified subscription amendment.
         * @summary Get amendments by key
         * @param {string} amendmentKey Can be the amendment ID or the amendment code.
         ...
         */
        gETAmendmentsByKey: async (amendmentKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'amendmentKey' is not null or undefined
            if (amendmentKey === null || amendmentKey === undefined) {
                throw new RequiredError('amendmentKey','Required parameter amendmentKey was null or undefined when calling gETAmendmentsByKey.');
            }
            const localVarPath = `/v1/amendments/{amendment-key}`
         ...
         * @param {string} subscriptionId The ID of the subscription whose amendment changes you want to retrieve.
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        gETAmendmentsBySubscriptionID: async (subscriptionId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'subscriptionId' is not null or undefined
            if (subscriptionId === null || subscriptionId === undefined) {
                throw new RequiredError('subscriptionId','Required parameter subscriptionId was null or undefined when calling gETAmendmentsBySubscriptionID.');
            }
            const localVarPath = `/v1/amendments/subscriptions/{subscription-id}`
         ...
         * @throws {RequiredError}
         */
        objectDELETEAmendment: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectDELETEAmendment.');
            }
            const localVarPath = `/v1/object/amendment/{id}`
         ...
         * @throws {RequiredError}
         */
        objectGETAmendment: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectGETAmendment.');
            }
            const localVarPath = `/v1/object/amendment/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {string} id Object id
         * @param {ProxyModifyAmendment} modifyRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPUTAmendment: async (id: string, modifyRequest: ProxyModifyAmendment, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectPUTAmendment.');
            }
            // verify required parameter 'modifyRequest' is not null or undefined
            if (modifyRequest === null || modifyRequest === undefined) {
                throw new RequiredError('modifyRequest','Required parameter modifyRequest was null or undefined when calling objectPUTAmendment.');
            }
            const localVarPath = `/v1/object/amendment/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
/**
 * AmendmentsApi - functional programming interface
 * @export
 */
export const AmendmentsApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Retrieves detailed information about the specified subscription amendment.
         * @summary Get amendments by key
         ...
         * @throws {RequiredError}
         */
        async gETAmendmentsByKey(amendmentKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETAmendmentType>> {
            const localVarAxiosArgs = await AmendmentsApiAxiosParamCreator(configuration).gETAmendmentsByKey(amendmentKey, zuoraTrackId, zuoraEntityIds, options);
         ...
         * @throws {RequiredError}
         */
        async gETAmendmentsBySubscriptionID(subscriptionId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETAmendmentType>> {
            const localVarAxiosArgs = await AmendmentsApiAxiosParamCreator(configuration).gETAmendmentsBySubscriptionID(subscriptionId, zuoraTrackId, zuoraEntityIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectDELETEAmendment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyDeleteResponse>> {
            const localVarAxiosArgs = await AmendmentsApiAxiosParamCreator(configuration).objectDELETEAmendment(id, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectGETAmendment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyGetAmendment>> {
            const localVarAxiosArgs = await AmendmentsApiAxiosParamCreator(configuration).objectGETAmendment(id, zuoraEntityIds, zuoraTrackId, fields, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPUTAmendment(id: string, modifyRequest: ProxyModifyAmendment, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await AmendmentsApiAxiosParamCreator(configuration).objectPUTAmendment(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * AmendmentsApi - factory interface
 * @export
 */
export const AmendmentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Retrieves detailed information about the specified subscription amendment.
         * @summary Get amendments by key
         ...
         * @throws {RequiredError}
         */
        gETAmendmentsByKey(amendmentKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<GETAmendmentType> {
            return AmendmentsApiFp(configuration).gETAmendmentsByKey(amendmentKey, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves detailed information about the amendment with the specified subscription.
         * @summary Get amendments by subscription ID
         ...
         * @throws {RequiredError}
         */
        gETAmendmentsBySubscriptionID(subscriptionId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any): AxiosPromise<GETAmendmentType> {
            return AmendmentsApiFp(configuration).gETAmendmentsBySubscriptionID(subscriptionId, zuoraTrackId, zuoraEntityIds, options).then((request) => request(axios, basePath));
        },
        /**
         *  Invoiced amendments cannot usually be deleted. One exception to this rule is auto-renew amendments. You can delete the last auto-renew amendment even if an invoice has been generated. 
         * @summary CRUD: Delete amendment
         ...
         * @throws {RequiredError}
         */
        objectDELETEAmendment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyDeleteResponse> {
            return AmendmentsApiFp(configuration).objectDELETEAmendment(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Get amendment
         ...
         * @throws {RequiredError}
         */
        objectGETAmendment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): AxiosPromise<ProxyGetAmendment> {
            return AmendmentsApiFp(configuration).objectGETAmendment(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Update amendment
         ...
         * @throws {RequiredError}
         */
        objectPUTAmendment(id: string, modifyRequest: ProxyModifyAmendment, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return AmendmentsApiFp(configuration).objectPUTAmendment(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * AmendmentsApi - object-oriented interface
 * @export
 * @class AmendmentsApi
 * @extends {BaseAPI}
 */
export class AmendmentsApi extends BaseAPI {
    /**
     * Retrieves detailed information about the specified subscription amendment.
     * @summary Get amendments by key
     * @param {string} amendmentKey Can be the amendment ID or the amendment code.
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof AmendmentsApi
     */
    public gETAmendmentsByKey(amendmentKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return AmendmentsApiFp(this.configuration).gETAmendmentsByKey(amendmentKey, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AmendmentsApi
     */
    public gETAmendmentsBySubscriptionID(subscriptionId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options?: any) {
        return AmendmentsApiFp(this.configuration).gETAmendmentsBySubscriptionID(subscriptionId, zuoraTrackId, zuoraEntityIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AmendmentsApi
     */
    public objectDELETEAmendment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return AmendmentsApiFp(this.configuration).objectDELETEAmendment(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AmendmentsApi
     */
    public objectGETAmendment(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any) {
        return AmendmentsApiFp(this.configuration).objectGETAmendment(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AmendmentsApi
     */
    public objectPUTAmendment(id: string, modifyRequest: ProxyModifyAmendment, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return AmendmentsApiFp(this.configuration).objectPUTAmendment(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
