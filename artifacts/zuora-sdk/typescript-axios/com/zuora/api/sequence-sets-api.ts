...
// @ts-ignore
import { GETSequenceSetResponse } from '../../../com/zuora/models';
// @ts-ignore
import { GETSequenceSetsResponse } from '../../../com/zuora/models';
// @ts-ignore
import { POSTSequenceSetsRequest } from '../../../com/zuora/models';
// @ts-ignore
import { POSTSequenceSetsResponse } from '../../../com/zuora/models';
// @ts-ignore
import { PUTSequenceSetRequest } from '../../../com/zuora/models';
// @ts-ignore
import { PUTSequenceSetResponse } from '../../../com/zuora/models';
/**
 * SequenceSetsApi - axios parameter creator
 * @export
 */
export const SequenceSetsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @param {string} id The ID of the sequence set to delete. 
         ...
         */
        dELETESequenceSet: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling dELETESequenceSet.');
            }
            const localVarPath = `/v1/sequence-sets/{id}`
         ...
         * @param {string} id The ID of the sequence set to retrieve information about. 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        gETSequenceSet: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling gETSequenceSet.');
            }
            const localVarPath = `/v1/sequence-sets/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {string} [name] The name of a specific sequence set. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        gETSequenceSets: async (zuoraEntityIds?: string, zuoraTrackId?: string, pageSize?: number, page?: number, name?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/sequence-sets`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @param {POSTSequenceSetsRequest} request 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        pOSTSequenceSets: async (request: POSTSequenceSetsRequest, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'request' is not null or undefined
            if (request === null || request === undefined) {
                throw new RequiredError('request','Required parameter request was null or undefined when calling pOSTSequenceSets.');
            }
            const localVarPath = `/v1/sequence-sets`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
         ...
         * @param {string} id The ID of the sequence set to update. 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         ...
         * @throws {RequiredError}
         */
        pUTSequenceSet: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, request?: PUTSequenceSetRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling pUTSequenceSet.');
            }
            const localVarPath = `/v1/sequence-sets/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
/**
 * SequenceSetsApi - functional programming interface
 * @export
 */
export const SequenceSetsApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Deletes a specific sequence set configured for billing documents, payments, and refunds. Billing documents include invoices, credit memos, and debit memos.  **Note**: The Credit and Debit Memos feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  
         * @summary Delete sequence set
         ...
         * @throws {RequiredError}
         */
        async dELETESequenceSet(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResponseType>> {
            const localVarAxiosArgs = await SequenceSetsApiAxiosParamCreator(configuration).dELETESequenceSet(id, zuoraEntityIds, zuoraTrackId, options);
         ...
         * @throws {RequiredError}
         */
        async gETSequenceSet(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETSequenceSetResponse>> {
            const localVarAxiosArgs = await SequenceSetsApiAxiosParamCreator(configuration).gETSequenceSet(id, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async gETSequenceSets(zuoraEntityIds?: string, zuoraTrackId?: string, pageSize?: number, page?: number, name?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETSequenceSetsResponse>> {
            const localVarAxiosArgs = await SequenceSetsApiAxiosParamCreator(configuration).gETSequenceSets(zuoraEntityIds, zuoraTrackId, pageSize, page, name, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pOSTSequenceSets(request: POSTSequenceSetsRequest, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<POSTSequenceSetsResponse>> {
            const localVarAxiosArgs = await SequenceSetsApiAxiosParamCreator(configuration).pOSTSequenceSets(request, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async pUTSequenceSet(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, request?: PUTSequenceSetRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PUTSequenceSetResponse>> {
            const localVarAxiosArgs = await SequenceSetsApiAxiosParamCreator(configuration).pUTSequenceSet(id, zuoraEntityIds, zuoraTrackId, request, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * SequenceSetsApi - factory interface
 * @export
 */
export const SequenceSetsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Deletes a specific sequence set configured for billing documents, payments, and refunds. Billing documents include invoices, credit memos, and debit memos.  **Note**: The Credit and Debit Memos feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  
         * @summary Delete sequence set
         ...
         * @throws {RequiredError}
         */
        dELETESequenceSet(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<CommonResponseType> {
            return SequenceSetsApiFp(configuration).dELETESequenceSet(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves information about a specific sequence set configured for billing documents, payments, and refunds. Billing documents include invoices, credit memos, and debit memos  **Note**: The Credit and Debit Memos feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  
         * @summary Get sequence set
         ...
         * @throws {RequiredError}
         */
        gETSequenceSet(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<GETSequenceSetResponse> {
            return SequenceSetsApiFp(configuration).gETSequenceSet(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves information about all sequence sets configured for billing documents, payments, and refunds. Billing documents include invoices, credit memos, and debit memos.  You can use query parameters to restrict the data returned in the response.  **Note**: The Credit and Debit Memos feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  
         * @summary Get sequence sets
         ...
         * @throws {RequiredError}
         */
        gETSequenceSets(zuoraEntityIds?: string, zuoraTrackId?: string, pageSize?: number, page?: number, name?: string, options?: any): AxiosPromise<GETSequenceSetsResponse> {
            return SequenceSetsApiFp(configuration).gETSequenceSets(zuoraEntityIds, zuoraTrackId, pageSize, page, name, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates sequence sets, allowing distinct numbering sequences for billing documents, payments, and refunds. Billing documents include invoices, credit memos, and debit memos.  You can create a maximum of 100 sequence sets in one single request. A sequence set comprises a set of custom prefixes and starting numbers that are used for billing documents to generate, and payments and refunds to create.  See [Prefix and Numbering Configuration for Billing Documents](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Prefix_and_Numbering_Configuration_for_Billing_Documents) for more information about limitations.  **Note**: The Credit and Debit Memos feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  
         * @summary Create sequence sets
         ...
         * @throws {RequiredError}
         */
        pOSTSequenceSets(request: POSTSequenceSetsRequest, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<POSTSequenceSetsResponse> {
            return SequenceSetsApiFp(configuration).pOSTSequenceSets(request, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates a specific sequence set configured for billing documents, payments, and refunds. Billing documents include invoices, credit memos, and debit memos.  **Note**: The Credit and Debit Memos feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  
         * @summary Update sequence set
         ...
         * @throws {RequiredError}
         */
        pUTSequenceSet(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, request?: PUTSequenceSetRequest, options?: any): AxiosPromise<PUTSequenceSetResponse> {
            return SequenceSetsApiFp(configuration).pUTSequenceSet(id, zuoraEntityIds, zuoraTrackId, request, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * SequenceSetsApi - object-oriented interface
 * @export
 * @class SequenceSetsApi
 * @extends {BaseAPI}
 */
export class SequenceSetsApi extends BaseAPI {
    /**
     * Deletes a specific sequence set configured for billing documents, payments, and refunds. Billing documents include invoices, credit memos, and debit memos.  **Note**: The Credit and Debit Memos feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  
     * @summary Delete sequence set
     * @param {string} id The ID of the sequence set to delete. 
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof SequenceSetsApi
     */
    public dELETESequenceSet(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return SequenceSetsApiFp(this.configuration).dELETESequenceSet(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SequenceSetsApi
     */
    public gETSequenceSet(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return SequenceSetsApiFp(this.configuration).gETSequenceSet(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SequenceSetsApi
     */
    public gETSequenceSets(zuoraEntityIds?: string, zuoraTrackId?: string, pageSize?: number, page?: number, name?: string, options?: any) {
        return SequenceSetsApiFp(this.configuration).gETSequenceSets(zuoraEntityIds, zuoraTrackId, pageSize, page, name, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SequenceSetsApi
     */
    public pOSTSequenceSets(request: POSTSequenceSetsRequest, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return SequenceSetsApiFp(this.configuration).pOSTSequenceSets(request, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SequenceSetsApi
     */
    public pUTSequenceSet(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, request?: PUTSequenceSetRequest, options?: any) {
        return SequenceSetsApiFp(this.configuration).pUTSequenceSet(id, zuoraEntityIds, zuoraTrackId, request, options).then((request) => request(this.axios, this.basePath));
    }
