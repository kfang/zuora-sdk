...
// @ts-ignore
import { GETProductRatePlansResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyBadRequestResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyCreateOrModifyResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyCreateProductRatePlan } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyDeleteResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyGetProductRatePlan } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyModifyProductRatePlan } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyNoDataResponse } from '../../../com/zuora/models';
// @ts-ignore
import { ProxyUnauthorizedResponse } from '../../../com/zuora/models';
/**
 * ProductRatePlansApi - axios parameter creator
 * @export
 */
export const ProductRatePlansApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Retrieves information about all product rate plans of a specific product. 
         * @summary Get product rate plans
         * @param {string} productId The unique ID of a product. For example, 2c92c0f96487e16a016487f663c71a61. 
         ...
         */
        gETProductRatePlans: async (productId: string, zuoraTrackId?: string, zuoraEntityIds?: string, page?: number, pageSize?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'productId' is not null or undefined
            if (productId === null || productId === undefined) {
                throw new RequiredError('productId','Required parameter productId was null or undefined when calling gETProductRatePlans.');
            }
            const localVarPath = `/v1/rateplan/{product_id}/productRatePlan`
         ...
         * @throws {RequiredError}
         */
        objectDELETEProductRatePlan: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectDELETEProductRatePlan.');
            }
            const localVarPath = `/v1/object/product-rate-plan/{id}`
         ...
         * @throws {RequiredError}
         */
        objectGETProductRatePlan: async (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectGETProductRatePlan.');
            }
            const localVarPath = `/v1/object/product-rate-plan/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
         ...
         * @param {ProxyCreateProductRatePlan} createRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPOSTProductRatePlan: async (createRequest: ProxyCreateProductRatePlan, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'createRequest' is not null or undefined
            if (createRequest === null || createRequest === undefined) {
                throw new RequiredError('createRequest','Required parameter createRequest was null or undefined when calling objectPOSTProductRatePlan.');
            }
            const localVarPath = `/v1/object/product-rate-plan`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @param {string} id Object id
         * @param {ProxyModifyProductRatePlan} modifyRequest 
         * @param {string} [zuoraEntityIds] An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
         * @param {string} [zuoraTrackId] A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        objectPUTProductRatePlan: async (id: string, modifyRequest: ProxyModifyProductRatePlan, zuoraEntityIds?: string, zuoraTrackId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling objectPUTProductRatePlan.');
            }
            // verify required parameter 'modifyRequest' is not null or undefined
            if (modifyRequest === null || modifyRequest === undefined) {
                throw new RequiredError('modifyRequest','Required parameter modifyRequest was null or undefined when calling objectPUTProductRatePlan.');
            }
            const localVarPath = `/v1/object/product-rate-plan/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
/**
 * ProductRatePlansApi - functional programming interface
 * @export
 */
export const ProductRatePlansApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Retrieves information about all product rate plans of a specific product. 
         * @summary Get product rate plans
         ...
         * @throws {RequiredError}
         */
        async gETProductRatePlans(productId: string, zuoraTrackId?: string, zuoraEntityIds?: string, page?: number, pageSize?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GETProductRatePlansResponse>> {
            const localVarAxiosArgs = await ProductRatePlansApiAxiosParamCreator(configuration).gETProductRatePlans(productId, zuoraTrackId, zuoraEntityIds, page, pageSize, options);
         ...
         * @throws {RequiredError}
         */
        async objectDELETEProductRatePlan(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyDeleteResponse>> {
            const localVarAxiosArgs = await ProductRatePlansApiAxiosParamCreator(configuration).objectDELETEProductRatePlan(id, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectGETProductRatePlan(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyGetProductRatePlan>> {
            const localVarAxiosArgs = await ProductRatePlansApiAxiosParamCreator(configuration).objectGETProductRatePlan(id, zuoraEntityIds, zuoraTrackId, fields, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPOSTProductRatePlan(createRequest: ProxyCreateProductRatePlan, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await ProductRatePlansApiAxiosParamCreator(configuration).objectPOSTProductRatePlan(createRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async objectPUTProductRatePlan(id: string, modifyRequest: ProxyModifyProductRatePlan, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProxyCreateOrModifyResponse>> {
            const localVarAxiosArgs = await ProductRatePlansApiAxiosParamCreator(configuration).objectPUTProductRatePlan(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * ProductRatePlansApi - factory interface
 * @export
 */
export const ProductRatePlansApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Retrieves information about all product rate plans of a specific product. 
         * @summary Get product rate plans
         ...
         * @throws {RequiredError}
         */
        gETProductRatePlans(productId: string, zuoraTrackId?: string, zuoraEntityIds?: string, page?: number, pageSize?: number, options?: any): AxiosPromise<GETProductRatePlansResponse> {
            return ProductRatePlansApiFp(configuration).gETProductRatePlans(productId, zuoraTrackId, zuoraEntityIds, page, pageSize, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Delete ProductRatePlan
         ...
         * @throws {RequiredError}
         */
        objectDELETEProductRatePlan(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyDeleteResponse> {
            return ProductRatePlansApiFp(configuration).objectDELETEProductRatePlan(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Get product rate plan
         ...
         * @throws {RequiredError}
         */
        objectGETProductRatePlan(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any): AxiosPromise<ProxyGetProductRatePlan> {
            return ProductRatePlansApiFp(configuration).objectGETProductRatePlan(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Create product rate plan
         ...
         * @throws {RequiredError}
         */
        objectPOSTProductRatePlan(createRequest: ProxyCreateProductRatePlan, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return ProductRatePlansApiFp(configuration).objectPOSTProductRatePlan(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CRUD: Update product rate plan
         ...
         * @throws {RequiredError}
         */
        objectPUTProductRatePlan(id: string, modifyRequest: ProxyModifyProductRatePlan, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any): AxiosPromise<ProxyCreateOrModifyResponse> {
            return ProductRatePlansApiFp(configuration).objectPUTProductRatePlan(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * ProductRatePlansApi - object-oriented interface
 * @export
 * @class ProductRatePlansApi
 * @extends {BaseAPI}
 */
export class ProductRatePlansApi extends BaseAPI {
    /**
     * Retrieves information about all product rate plans of a specific product. 
     * @summary Get product rate plans
     * @param {string} productId The unique ID of a product. For example, 2c92c0f96487e16a016487f663c71a61. 
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ProductRatePlansApi
     */
    public gETProductRatePlans(productId: string, zuoraTrackId?: string, zuoraEntityIds?: string, page?: number, pageSize?: number, options?: any) {
        return ProductRatePlansApiFp(this.configuration).gETProductRatePlans(productId, zuoraTrackId, zuoraEntityIds, page, pageSize, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductRatePlansApi
     */
    public objectDELETEProductRatePlan(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return ProductRatePlansApiFp(this.configuration).objectDELETEProductRatePlan(id, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductRatePlansApi
     */
    public objectGETProductRatePlan(id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options?: any) {
        return ProductRatePlansApiFp(this.configuration).objectGETProductRatePlan(id, zuoraEntityIds, zuoraTrackId, fields, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductRatePlansApi
     */
    public objectPOSTProductRatePlan(createRequest: ProxyCreateProductRatePlan, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return ProductRatePlansApiFp(this.configuration).objectPOSTProductRatePlan(createRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductRatePlansApi
     */
    public objectPUTProductRatePlan(id: string, modifyRequest: ProxyModifyProductRatePlan, zuoraEntityIds?: string, zuoraTrackId?: string, options?: any) {
        return ProductRatePlansApiFp(this.configuration).objectPUTProductRatePlan(id, modifyRequest, zuoraEntityIds, zuoraTrackId, options).then((request) => request(this.axios, this.basePath));
    }
