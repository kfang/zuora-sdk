...
import { SubscribeRequestPaymentMethodGatewayOptionData } from './subscribe-request-payment-method-gateway-option-data';
 ...
 * @export
 * @interface SubscribeRequestPaymentMethod
 */
export interface SubscribeRequestPaymentMethod {
    /**
     *  The ID of the customer account associated with this payment method. 
     * @type {string}
     * @memberof SubscribeRequestPaymentMethod
     */
    AccountId?: string;
    /**
