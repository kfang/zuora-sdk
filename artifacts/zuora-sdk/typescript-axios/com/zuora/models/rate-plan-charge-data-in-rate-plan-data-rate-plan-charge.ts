 ...
 * 
 * @export
 * @interface RatePlanChargeDataInRatePlanDataRatePlanCharge
 */
export interface RatePlanChargeDataInRatePlanDataRatePlanCharge {
    /**
     ...
     * @type {string}
     * @memberof RatePlanChargeDataInRatePlanDataRatePlanCharge
     */
