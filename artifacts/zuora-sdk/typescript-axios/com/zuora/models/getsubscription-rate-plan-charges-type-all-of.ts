...
import { GETDiscountApplyDetailsType } from './getdiscount-apply-details-type';
import { GETTierType } from './gettier-type';

/**
 * 
 * @export
 * @interface GETSubscriptionRatePlanChargesTypeAllOf
 */
export interface GETSubscriptionRatePlanChargesTypeAllOf {
    /**
     ...
     * @type {string}
     * @memberof GETSubscriptionRatePlanChargesTypeAllOf
     */
