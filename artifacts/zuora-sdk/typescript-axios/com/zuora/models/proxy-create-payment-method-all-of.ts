...
import { ProxyCreatePaymentAllOfGatewayOptionData } from './proxy-create-payment-all-of-gateway-option-data';

/**
 * 
 * @export
 * @interface ProxyCreatePaymentMethodAllOf
 */
export interface ProxyCreatePaymentMethodAllOf {
    /**
     ...
     * @type {string}
     * @memberof ProxyCreatePaymentMethodAllOf
     */
    AccountId?: string;
    /**
     ...
     * @memberof ProxyCreatePaymentMethodAllOf
     */
    Type?: ProxyCreatePaymentMethodAllOfTypeEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum ProxyCreatePaymentMethodAllOfTypeEnum {
    ACH = 'ACH',
